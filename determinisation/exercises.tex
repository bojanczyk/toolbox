...
\exercise{zad:01-02}{
Call an $\omega$-word  \emph{ultimately periodic} if it is of the form $uv^\omega$ for some finite words $u,v$. Show that if an $\omega$-regular langauge  is nonempty, then it contains an ultimately periodic word.}
{
