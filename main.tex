...
\ignore{
\input{determinisation/theory}
\input{buchi-landweber/theory}	
\input{quasipol/theory}
\input{distance-automata/theory}
\input{tree-aut/theory}
\input{courcelle/theory}
\input{twa/theory}
\input{linear-automata/theory}
\input{wqo/theory}
\input{hilbert/theory}
\input{tarski/theory}
\input{valiant/theory}
\input{two-way/theory}
\input{angluin/theory}
\input{sst/theory}
\input{determinisation/exercises}
\input{buchi-landweber/exercises}	
\input{quasipol/exercises}
\input{distance-automata/exercises}
\input{twa/exercises}
\input{tree-aut/exercises}
\input{courcelle/exercises}
\input{linear-automata/exercises}
\input{wqo/exercises}
\input{tarski/exercises}
\input{hilbert/exercises}
\input{valiant/exercises}
\input{two-way/exercises}
\input{angluin/exercises}
\input{sst/exercises}
